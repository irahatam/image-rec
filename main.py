...
def process_file(filepath):
    ...
    # TODO 8: Load the image into the array, run the interference
    ...
    if prediction.item(0) > PREDICTION_THRESHOLD:
      return "Yay! You're {}% {}. Please stay safe!".format(prediction_text,COMPARISON_ITEM)
    else:
      return "Oops! You are not {}! Please wear a mask and stay safe.".format(COMPARISON_ITEM)
